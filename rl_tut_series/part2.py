...
class agent():
    def __init__(self, lr, s_size, a_size, h_size):
        ...
        # TODO: instead of doing all this cant we just call trainer.minimise(loss)?
        ...
        # Find the gradient of the loss wrt to each variable in tvars.
    ...
    with tf.Session() as sess:
        ...
        while i < total_episodes:
            ...
            for j in range(max_ep):
                ...
                print '-----------'
                print type(ep_history)

                # Update the network if 'done'.
                if d:
                    # First get the gradients #TODO: figure out.
            ...
            if i % 100 == 0:
                print "Episode {}. Average total reward after {} steps: {}".format(i, j, np.mean(total_reward[-100:]))
            i += 1
